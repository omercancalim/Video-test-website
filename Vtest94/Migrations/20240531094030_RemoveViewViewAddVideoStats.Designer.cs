...
namespace Vtest94.Migrations
{
    ...
    [Migration("20240531094030_RemoveViewViewAddVideoStats")]
    partial class RemoveViewViewAddVideoStats
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Vtest94.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vtest94.Models.VideoStats", b =>
                {
                    b.HasOne("Vtest94.Models.Video", "Video")
                        .WithOne("VideoStats")
                        .HasForeignKey("Vtest94.Models.VideoStats", "VideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
